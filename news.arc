...
(= this-site*    "Alex News"
   site-url*     "code.readevalprint.com:8080"
   parent-url*   "code.readevalprint.com:8080"
   favicon-url*  ""
   site-desc*    "All things alex"               ; for rss feed
   site-color*   (color 25 61 85)
...
.pagetop { font-family:Verdana; font-size: 10pt; color:#ccc; }
